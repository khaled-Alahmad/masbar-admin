...
const AddProviderServicePricesModal = ({
  isOpen,
  providerId,
  onClose,
  itemId,
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await postData(`/admin/provider-service-prices`, data);
      if (response.success) {
  ...
  return (
    ...
    >
      <ModalContent>
        <ModalHeader>Add Provider Service Price</ModalHeader>
        <ModalBody>
...
export default AddProviderServicePricesModal;
